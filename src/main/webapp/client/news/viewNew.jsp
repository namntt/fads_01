...
<div class="row">
	<div class="col-md-6">
		<s:form  id="formComment" >
			...
			<h2><s:text name="client.action.comment" /></h2>
				...
				<div class="comment-main-level">
					<div class="comment-box">
						<div class="comment-head">
							<h6 class="comment-name by-author"><s:property value="#parentComment.userAccount.username"/></h6>
					...
					<s:iterator value="comments" var="subComment">
						<s:if test="#subComment.parentId==#parentComment.id">
							<ul class="comments-list reply-list">
								<li>
									...
									<div class="comment-box">
										<div class="comment-head">
											<h6 class="comment-name"><s:property value="#subComment.userAccount.username"/></h6>
											<span>hace 10 minutos</span>
										</div>
										<div class="comment-content">
											<div><s:property value="#subComment.description"/></div>
										</div>
									</div>
								</li>
							</ul>
					...
					<div class="subComment-append"></div>
					<s:form class="subDescription">
						<div class="form	-group">
